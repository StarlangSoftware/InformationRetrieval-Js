...
class Parameter {
    indexType = IndexType_1.IndexType.INVERTED_INDEX;
    wordComparator = WordComparator_1.WordComparator.TURKISH;
    indexesFromFile = false;
    disambiguator;
    fsm;
    documentNormalization = false;
    phraseIndex = true;
    positionalIndex = true;
    nGramIndex = true;
    limitDocumentsLoaded = false;
    documentLimit = 1000;
    wordLimit = 10000;
    documentType = DocumentType_1.DocumentType.NORMAL;
